...
// ✅ FIXED: Get PLAY AGAIN button reference
...
function loadQuestion() {
    ...
    // ✅ FIXED: Handle JSON keys with or without trailing spaces
    const questionText = (q.question || q['question '] || 'Loading...').trim();
    ...
    // ✅ FIXED: Handle options with or without trailing spaces
